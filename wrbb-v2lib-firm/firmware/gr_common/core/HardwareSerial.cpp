...
static const SciInterruptRegistersTableStruct SciInterruptRegistersTable[] = {
  {VECT_SCI0_TXI0, VECT_SCI0_RXI0/*IER_SCI0_TXI0, 7, IER_SCI0_RXI0, 6*/, IR_SCI0_TXI0, IR_SCI0_RXI0, IPR_SCI0_TXI0, IPR_SCI0_RXI0, 0},
  {VECT_SCI6_TXI6, VECT_SCI6_RXI6/*IER_SCI6_TXI6, 1, IER_SCI6_RXI6, 0*/, IR_SCI6_TXI6, IR_SCI6_RXI6, IPR_SCI6_TXI6, IPR_SCI6_RXI6, 6},
  {VECT_SCI2_TXI2, VECT_SCI2_RXI2/*IER_SCI2_TXI2, 5, IER_SCI2_RXI2, 4*/, IR_SCI2_TXI2, IR_SCI2_RXI2, IPR_SCI2_TXI2, IPR_SCI2_RXI2, 2},
  {VECT_SCI3_TXI3, VECT_SCI3_RXI3/*IER_SCI3_TXI3, 0, IER_SCI3_RXI3, 7*/, IR_SCI3_TXI3, IR_SCI3_RXI3, IPR_SCI3_TXI3, IPR_SCI3_RXI3, 3},
  {VECT_SCI5_TXI5, VECT_SCI5_RXI5/*IER_SCI5_TXI5, 6, IER_SCI5_RXI5, 5*/, IR_SCI5_TXI5, IR_SCI5_RXI5, IPR_SCI5_TXI5, IPR_SCI5_RXI5, 5},
  {VECT_SCI8_TXI8, VECT_SCI8_RXI8/*IER_SCI8_TXI8, 7, IER_SCI8_RXI8, 6*/, IR_SCI8_TXI8, IR_SCI8_RXI8, IPR_SCI8_TXI8, IPR_SCI8_RXI8, 8},
  {VECT_SCI1_TXI1, VECT_SCI1_RXI1/*IER_SCI1_TXI1, 2, IER_SCI1_RXI1, 1*/, IR_SCI1_TXI1, IR_SCI1_RXI1, IPR_SCI1_TXI1, IPR_SCI1_RXI1, 1},
};
  ...
  case 7:
    ...
    //  const uint8_t SERIAL_D5 = 0b00000000;
...

      {
        ...
        enableInterrupt(t->_txint);
        enableInterrupt(t->_rxint);
        ...
        enableInterrupt(VECT_ICU_GROUP12);
  ...
  case 7:
...
#if defined(HAVE_HWSERIAL1) || defined(HAVE_HWSERIAL2) || defined(HAVE_HWSERIAL3) || defined(HAVE_HWSERIAL4) || defined(HAVE_HWSERIAL5) || defined(HAVE_HWSERIAL6) || defined(HAVE_HWSERIAL7)
    {
      flush();
      {
        ...
        disableInterrupt(t->_txint);
        disableInterrupt(t->_rxint);
