...
#if TNUM_PORT >= 6						/* ポート6に関する定義 */

#ifndef SERIAL_RCV_BUFSZ6
#define	SERIAL_RCV_BUFSZ6	256			/* ポート6の受信バッファサイズ */
#endif /* SERIAL_RCV_BUFSZ6 */

#ifndef SERIAL_SND_BUFSZ6
#define	SERIAL_SND_BUFSZ6	256			/* ポート6の送信バッファサイズ */
#endif /* SERIAL_SND_BUFSZ6 */

static char	rcv_buffer6[SERIAL_RCV_BUFSZ6];
static char	snd_buffer6[SERIAL_SND_BUFSZ6];

#endif /* TNUM_PORT >= 6 */

#if TNUM_PORT >= 7
#error Serial interface driver supports up to 6 ports.
#endif /* TNUM_PORT >= 7 */
