 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_timer.c 1625 2018-08-06 03:54:19Z coas-nagasima $
 */

/*
 *		タイマドライバ（GR-SAKURA/CITRUS用）
 */
...
target_timer_initialize(intptr_t exinf)
{
	 ...
	 *  タイマ動作開始前の割込み要求をクリア
	 */
	x_clear_int(INTNO_TIMER0);
	x_clear_int(INTNO_TIMER1);
...
target_hrt_raise_event(void)
{
	...
	x_clear_int(INTNO_TIMER0);			/* 要求クリア		*/
...
target_ovrtimer_raise_event(void)
{
	...
	x_clear_int(INTNO_TIMER2);			/* 要求クリア		*/
