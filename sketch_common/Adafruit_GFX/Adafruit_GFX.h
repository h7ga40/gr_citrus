...
class Adafruit_GFX : public Print {
 ...
 public:
  ...
  void
    ...
    drawFont(int16_t x, int16_t y, uint8_t *bitmap,
      int16_t w, int16_t h, uint16_t color, uint16_t bg),
    drawChar(int16_t x, int16_t y, const char *utf8, uint16_t color,
      uint16_t bg, uint8_t size),
    drawString(int16_t x, int16_t y, const char *string, uint16_t color,
      uint16_t bg),
