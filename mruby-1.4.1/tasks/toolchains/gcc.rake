MRuby::Toolchain.new(:gcc) do |conf, _params|
  [conf.cc, conf.objc, conf.asm].each do |cc|
    ...
    cc.flags = [ENV['CFLAGS'] || %w(-g -std=gnu99 -Og -Wall -Werror-implicit-function-declaration -Wdeclaration-after-statement -Wwrite-strings -Wundef)]
  ...
  [conf.cxx].each do |cxx|
    ...
    cxx.flags = [ENV['CXXFLAGS'] || ENV['CFLAGS'] || %w(-g -Og -Wall -Werror-implicit-function-declaration -Wundef)]
